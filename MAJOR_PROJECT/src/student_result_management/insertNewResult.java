...
public class insertNewResult extends javax.swing.JFrame {
    ...
    private void savebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savebtnActionPerformed
        ...
        String mathsmarks = mathematicsfield.getText();
        String dbms = dbmsfield.getText();
        String osmarks = osfield.getText();
        
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/srm","root","Sopna@278");
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("Select * from student where rollno = '"+rollno+"'");
            if(rs.next()){
                st.executeUpdate("insert into result(rollno,physicsmarks,chemistrymarks,mathsmarks,dbms,osmarks) values('"+rollno+"','"+physicsmarks+"','"+chemistrymarks+"','"+mathsmarks+"','"+dbms+"','"+osmarks+"')");
